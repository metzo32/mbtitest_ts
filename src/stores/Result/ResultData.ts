...
export const ResultData: IResult[] = [
    ...
    },
    {
        ...
        best: "미트볼 피자",
        best2: "베이컨 피자",
        desc: "어디에서나 적절하게 잘 어울리고, 혼란스러움을 잠재우는 재주가 있으시군요. 당신을 마다할 사람이 있을까요? 정적이지만 동적이고, 동적이다가도 정적인 매력의 소유자인 당신! 뭘 좋아할지 몰라 다 준비해보았습니다. 콤비네이션 피자입니다!",
        image: `${combination}`,
    },
    {
        id: 4,
    ...
    },
    {
        ...
        best: "옥수수 피자",
        best2: "하와이안 피자",
        desc: "당신은 침착함, 책임감. 이 두 단어로 표현할 수 있어요. 성실하지만 자신의 능력을 과시하지 않는 어른스러운 면도 갖추셨군요. 자극적이지 않지만 담담하게 잘 정제된 당신! 우아하고 이국적인 루꼴라프로슈토 피자입니다.",
        image: `${prosciutto}`,
    },
    {
        id: 11,
