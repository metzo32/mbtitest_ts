...
export const ResultData: IResult[] = [
...

    {
        ...
        best: "옥수수 피자",
        best2: "하와이안 피자",
        desc: "섬세하고 정제된 취향인 당신. 당신만의 배려심으로 주변 사람들에게 안정감과 편안함을 주는 편입니다. 주변 사람들에게 따뜻한 정서적 지지를 줄 줄 아는군요! 향기롭고 온화한 당신은 트러플버섯 피자입니다.",
        image: `${mushroom}`,
    },
    {
        id: 8,
        ...
        best: "쉬림프 피자",
        best2: "치즈 피자",
        desc: "혹시 다재다능하다는 말을 많이 듣지 않나요? 호불호 없는 대중적인 명랑함을 갖추셨군요! 당신의 열정과 동기 부여를 통해 주변 사람들도 자신의 잠재력을 최대한 발휘합니다. 언제든, 어디서든 자신의 몫을 해내는 당신은 페퍼로니 피자입니다.",
        image: `${pepperoni}`,
    },
    {
        id: 9,
